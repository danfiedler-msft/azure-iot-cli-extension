...
class IotDpsClient:
    ...
    :vartype operations: dps.mgmt.operations.Operations
    :ivar iot_dps_resource: IotDpsResourceOperations operations
    :vartype iot_dps_resource: dps.mgmt.operations.IotDpsResourceOperations
    :ivar dps_certificate: DpsCertificateOperations operations
    :vartype dps_certificate: dps.mgmt.operations.DpsCertificateOperations
