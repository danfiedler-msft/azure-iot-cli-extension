...
class Deployment(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword deployment_id: The caller-provided deployment identifier. This cannot be longer than
         73 characters, must be all lower-case, and cannot contain '&', '^', '[', ']', '{', '}', '|',
         '<', '>', forward slash, backslash, or double quote. The Updates view in the Azure Portal IoT
         Hub resource generates a GUID for deploymentId when you create a deployment. Required.
...
class DeploymentDeviceStatesFilter(_serialization.Model):
    ...
    :vartype module_id: str
    :ivar device_state: The deployment device state. Known values are: "Succeeded", "InProgress",
     "Canceled", and "Failed".
    :vartype device_state: str or ~deviceupdateclient.models.DeviceDeploymentState
    """
    ...
    def __init__(
        ...
        *,
        ...
        module_id: Optional[str] = None,
        device_state: Optional[Union[str, "_models.DeviceDeploymentState"]] = None,
        **kwargs
    ):
        """
        ...
        :paramtype module_id: str
        :keyword device_state: The deployment device state. Known values are: "Succeeded",
         "InProgress", "Canceled", and "Failed".
        :paramtype device_state: str or ~deviceupdateclient.models.DeviceDeploymentState
        """
        super().__init__(**kwargs)
...
class Device(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        :keyword on_latest_update: Boolean flag indicating whether the latest update (the best
         compatible update for the device's device class and group) is installed on the device.
         Required.
...
class DeviceClass(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword device_class_id: The device class identifier. This is generated from the model Id and
        ...
        :keyword best_compatible_update: Update that is the highest version compatible with this device
         class.
...
class DeviceClassFilter(_serialization.Model):
    """Device class filter. Filters device classes based on device class friendly name.

    :ivar friendly_name: The friendly name of the device class to use in the filter.
    :vartype friendly_name: str
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword friendly_name: The friendly name of the device class to use in the filter.
        :paramtype friendly_name: str
        """
        super().__init__(**kwargs)
        self.friendly_name = friendly_name
...
class DeviceClassSubgroup(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword device_class_id: Device class subgroup identity. This is generated from the model Id
         and the compat properties reported by the device update agent in the Device Update PnP
...
class Group(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword group_id: Group identity. This is created from the value of the ADUGroup tag in the
         Iot Hub's device/module twin or $default for devices with no tag. Required.
        :paramtype group_id: str
...
class PatchBody(_serialization.Model):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        :keyword friendly_name: The device class friendly name. Friendly name can be 1-100 characters,
         alphanumeric, dot, and dash. Required.
        :paramtype friendly_name: str
        """
        super().__init__(**kwargs)
